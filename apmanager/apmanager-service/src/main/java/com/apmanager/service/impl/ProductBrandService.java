 ...
 * @author luis
 */
public class ProductBrandService extends BasicService<ProductBrand, ProductBrandDAO> {
    ...
    @Override
    public void validate(ProductBrand object, ServiceAction action) throws ValidationException {
