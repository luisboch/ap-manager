...
/**
  ...
  *   
  */   
public class JavaBeanResult implements QueryRedirector {
    ...
    public Object invokeQuery(DatabaseQuery query, Record arguments,  
       ...
       try {  
          ...
          Constructor<?> javaBeanClassConstructor =   
             (Constructor<?>) resultClass.getDeclaredConstructor(Long.class, String.class, ProductBrand.class, Date.class, String.class, 
            String.class, String.class, String.class, 
            Integer.class, Float.class, Float.class,
            Integer.class, Shelf.class, Integer.class, Boolean.class); 
